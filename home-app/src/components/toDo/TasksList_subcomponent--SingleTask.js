...
const SingleTask = ({toDo, username}) => {
    ...
    return <section className="singleTask">
        ...
        <div className="singleTask__panel">
            ...
            <button className="panelBtn panelBtn--delete" onClick={handleDeleteTask}><i className="fas fa-trash-alt"/>
            </button>}
            {task.archive === false &&
            <button className="panelBtn panelBtn--addOperation" onClick={handleChangeOpsFlag}><i
                className="fas fa-plus"/></button>}
            {task.archive === false &&
            <button className="panelBtn panelBtn--archive" onClick={handleArchiveTask}><i className="fas fa-archive"/>
            </button>}
        </div>
